...
#if UNITY_EDITOR
    using UnityEditor;
    using ComponentUI.Layouts;

    [CustomEditor(typeof(ComponentUIRadialGroup))]
    public class RadialGroupEditor : Editor
    {
        ComponentUIRadialGroup instance;

        public override void OnInspectorGUI()
        {
            instance = (ComponentUIRadialGroup)target;
...
{
    [ExecuteInEditMode]
    public class ComponentUIRadialGroup : MonoBehaviour
    {
